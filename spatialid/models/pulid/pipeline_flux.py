...
from spatialid.models.pulid.encoders_transformer import IDFormer, PerceiverAttentionCA
from spatialid.models.pulid.utils import img2tensor, tensor2img
...
class PuLIDPipeline(nn.Module):
    ...
    def load_pretrain(self, pretrain_path=None, version='v0.9.0'):
        ...
        ckpt_path = "/dev_share/gdli7/models/pulid/pulid_flux_v0.9.1.safetensors"
