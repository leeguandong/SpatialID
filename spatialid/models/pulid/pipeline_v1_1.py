...
from spatialid.models.eva_clip import create_model_and_transforms
from spatialid.models.eva_clip.constants import OPENAI_DATASET_MEAN, OPENAI_DATASET_STD
from spatialid.models.pulid.encoders_transformer import IDFormer
from spatialid.models.pulid.utils import is_torch2_available, sample_dpmpp_2m, sample_dpmpp_sde

if is_torch2_available():
    from spatialid.models.pulid.attention_processor import AttnProcessor2_0 as AttnProcessor
    from spatialid.models.pulid.attention_processor import IDAttnProcessor2_0 as IDAttnProcessor
else:
    from spatialid.models.pulid.attention_processor import AttnProcessor, IDAttnProcessor
